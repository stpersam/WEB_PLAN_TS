    ...
    <form name = "myForm" action="./utility/regValidate.php" method="post">
        <div class="Formularfenster" Id="eltern">
            ...
            <div class="form-group">
                ...
                <input type="number" name="plz" class="form-control" placeholder="1234" max="9999" minlength="4">
            </div>
            <div class="form-group">
            ...
            <button type="submit" name="registrieren" id="registrieren" class="btn btn-outline-secondary btn-secondary">Register</button>
    </form>
</div>
</div>
